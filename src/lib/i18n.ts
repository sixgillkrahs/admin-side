    ...
    translation: {
      ...
      rbac: {
        ...
        createRoleModal: {
          ...
          description: 'Define a new administrative role and assign specific permissions.',
          nameLabel: 'Role Name',
          ...
          errorEmpty: 'Role name cannot be empty.',
          cancel: 'Cancel',
          submit: 'Create Role',
        },
        audit: {
          title: 'Security Audit Logs',
          description: 'Chronological log of administrative operations and access adjustments.',
    ...
    translation: {
      ...
      rbac: {
        ...
        createRoleModal: {
          ...
          description: 'Định nghĩa một vai trò quản trị mới và phân quyền cụ thể.',
          ...
          errorEmpty: 'Tên vai trò không được để trống.',
          cancel: 'Hủy bỏ',
          submit: 'Tạo vai trò',
        },
        audit: {
          title: 'Nhật ký Kiểm toán Bảo mật',
          description: 'Nhật ký theo thời gian của các hoạt động quản trị và điều chỉnh quyền truy cập.',
